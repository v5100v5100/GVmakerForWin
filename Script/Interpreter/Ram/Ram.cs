...
namespace Script.Interpreter.Ram
{
    public class RamConst 
    {
         ...
         * 运行时内存类型
         */
        public const int RAM_RUNTIME_TYPE = 0x01;
        /**
         * 显存内存类型
         */
        public const int RAM_GRAPH_TYPE = 0x02;
        /**
         * 屏幕缓存类型
         */
        public const int RAM_BUFFER_TYPE = 0x04;
        /**
         * 文本缓冲区类型
         */
        public const int RAM_TEXT_TYPE = 0x08;
        /**
         * 字符堆内存类型
         */
        public const int RAM_STRING_TYPE = 0x10;
    }
