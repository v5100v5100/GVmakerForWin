...
namespace Script.Interpreter
{
    ...
    interface FileModel
    {
        ...
        /// <returns></returns>
        bool changeDir(Getable source, int addr);
        ...
        /// <param name="addr"></param>
        /// <returns></returns>
        bool makeDir(Getable source, int addr);
        ...
        int listFiles(string[] names, int start, int num);
        ...
        int fopen(Getable source, int fileName, int openMode);
        ...
        int fread(Setable dest, int addr, int size, int fp);
        ...
        int fwrite(Getable source, int addr, int size, int fp);
        ...
        /// <param name="addr"></param>
        /// <returns></returns>
        bool deleteFile(Getable source, int addr);
        ...
        int fseek(int fp, int offset, int base_);
